...
capucho auth login                          # once, stores an API key
capucho init                                # links this directory to a cloud app
capucho config list                          # what the CLI resolved, and which tools it found

capucho deploy ota --channel staging         # publish a web bundle
capucho deploy native --channel staging      # build and publish an APK
```
