...
Capuchoo is a modern, modular mobile-first application built with Vue 3, Framework7, and Capacitor
...
- **Updates**: OTA & Native updates powered by **Capuchoo Platform**.
