    ...
    <div v-if="activeApp" class="pb-safe">
      ...
      >
        <F7List no-hairlines-md class="no-margin">
          ...
          <F7ListItem
            title="Platform"
            :after="activeApp.platform.toUpperCase()"
          ></F7ListItem>
        </F7List>
        <F7Button
          fill
          ...
          round
          color="blue"
          class="mt-6 font-bold shadow-lg shadow-blue-500/20"
      ...
      >
        <p class="text-xs text-red-500 mb-6 font-medium leading-relaxed">
          Deleting this app will permanently remove all associated updates,
          bundles, and analytics data. This action cannot be undone.
        </p>
