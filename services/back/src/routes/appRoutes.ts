...
import { authenticate, checkAppAccess, requireAppAdmin, requireOrgAdmin } from "@/middleware";
...
router.post("/", requireOrgAdmin("body"), appController.create.bind(appController));
...
router.delete("/:id", requireAppAdmin(), appController.delete.bind(appController));

// App Permissions
router.get("/:id/permissions", checkAppAccess(), appController.getPermissions.bind(appController));

router.post("/:id/permissions", requireAppAdmin(), appController.setPermission.bind(appController));
...
router.get("/:id/releases", checkAppAccess(), adminController.getBundles.bind(adminController));
